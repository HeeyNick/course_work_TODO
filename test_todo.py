...
class TestAddDelete(unittest.TestCase):
	...
	def test_add_task_1(self):
		...
		self.assertEqual(rows, [(self.func_db.priority.normal, problem, self.func_db.status.unperf, today_test_str, date_end,1)])
	...
	def test_add_task_2(self):
		...
		id_ = 2
		rows = self.func_db.fetch_task_by_id(id_)
		self.assertEqual(rows, [(self.func_db.priority.normal, problem, self.func_db.status.unperf, today_test_str, date_end,2)])
...
class TestUpdatePerformed(unittest.TestCase):
	...
	def test_update_perf_task_1(self):
		...
		self.func_db.insert_db(self.func_db.priority.normal, problem_insert, self.func_db.status.unperf, date_end_insert)
		id_ = 1
		...
		problem_select = 'Один'
		self.assertEqual(rows, [(self.func_db.priority.normal, problem_select, self.func_db.status.perf, today_test_str, test_date_end, 1)])

	def test_update_perf_task_2(self):
		problem_insert = 'Два'
		date_end_insert = datetime.date(2020,12,4)
		self.func_db.insert_db(self.func_db.priority.normal, problem_insert, self.func_db.status.perf, date_end_insert)
		id_ = 2
		today_test_str = str(self.func_db.date_today)
		...
		test_date_end = str(datetime.date(2020,12,4))
		problem_select = 'Два'
		self.assertEqual(rows, [(self.func_db.priority.normal, problem_select, self.func_db.status.unperf, today_test_str, test_date_end, 2)])
...
class TestUpdatePriority(unittest.TestCase):
	...
	def test_update_prior_task_1(self):
		problem_insert = 'Один'
		date_end_insert = datetime.date(2020,12,4)
		self.func_db.insert_db(self.func_db.priority.major, problem_insert, self.func_db.status.unperf, date_end_insert)
		id_ = 1
		today_test_str = str(self.func_db.date_today)
		...
		test_date_end = str(datetime.date(2020,12,4))
		problem_select = 'Один'
		self.assertEqual(rows, [(self.func_db.priority.normal, problem_select, self.func_db.status.unperf, today_test_str, test_date_end, 1)])
	...
	def test_update_prior_task_2(self):
		...
		test_date_end = str(datetime.date(2020,12,4))
		problem_select = 'Два'
		self.assertEqual(rows, [(self.func_db.priority.major, problem_select, self.func_db.status.unperf, today_test_str, test_date_end, 2)])
...
class TestDeletePerformed(unittest.TestCase):
	...
	def test_delete_perf_1(self):
		...
		date_end_insert = datetime.date(2020,12,4)
		test_date_end = str(datetime.date(2020,12,4))
		self.func_db.insert_db(self.func_db.priority.normal, problem_insert_one, self.func_db.status.unperf, date_end_insert)
		self.func_db.insert_db(self.func_db.priority.major, problem_insert_two, self.func_db.status.perf, date_end_insert)
	...
	def test_delete_perf_2(self):
		...
		date_today = datetime.date.today()
		today_test_str = str(date_today)
		self.func_db.insert_db(self.func_db.priority.normal, problem_insert_five, self.func_db.status.unperf, date_end_insert)
		self.func_db.db.delete_perfomed_in_bd()
		id_ = 3
		rows = self.func_db.fetch_task_by_id(id_)
		self.assertEqual(rows, [(self.func_db.priority.normal, problem_insert_five, self.func_db.status.unperf, today_test_str, test_date_end,3)])
...
class TestClearAll(unittest.TestCase):
	...
	def test_clear_all(self):
		...
		date_today = datetime.date.today()
		today_test_str = str(date_today)
		self.func_db.insert_db(self.func_db.priority.normal, problem_insert_nine, self.func_db.status.unperf, date_end_insert)
		self.func_db.insert_db(self.func_db.priority.major, problem_insert_eight, self.func_db.status.perf, date_end_insert)
		self.func_db.insert_db(self.func_db.priority.major, problem_insert_six, self.func_db.status.unperf, date_end_insert)
